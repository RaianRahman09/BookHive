    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {books.map(book => (
                    <div key={book._id} className="bg-white shadow-lg rounded-2xl overflow-hidden">
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex justify-between">
                                <Link to={`/books/edit/${book._id}`}
                                    ...
                                    className="px-4 py-2 rounded-2xl border border-blue-500 hover:bg-blue-50 transition"
                                >
                                    Edit
                                </Link>
                                <button
                                    onClick={() => handleDelete(book._id)}
                                    className="px-4 py-2 rounded-2xl border border-red-500 text-red-500 hover:bg-red-50 transition"
                                >
                                    Delete
                                </button>
                            </div>
